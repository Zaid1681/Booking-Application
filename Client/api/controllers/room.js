...
export const updateRoom = async (req, res, next) =>{
    try {
        const updatedRoom =  await Hotels.findByIdAndUpdate(req.params.id , {$set :  req.body} , {new: true})//sending the latest version of our documents
